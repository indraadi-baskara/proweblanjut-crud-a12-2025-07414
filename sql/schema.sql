CREATE DATABASE
IF NOT EXISTS proweblanjut_crud_a12_2025_07414 CHARACTER
SET utf8mb4
...
-- -------------------------------------------------------------------------
INSERT INTO items
    (user_id, item_name, quantity, price, entry_date)
VALUES
    (1, 'Wireless Mouse', 45, 129000, '2025-01-10'),
    (1, 'Mechanical Keyboard', 3, 850000, '2025-02-14'),
    (1, 'USB-C Hub', 20, 320000, '2025-03-01'),
    (1, 'HDMI Cable 2m', 2, 75000, '2025-03-05'),
    (1, 'Laptop Stand', 12, 275000, '2025-03-08');
